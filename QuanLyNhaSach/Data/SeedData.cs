            ...
            serviceProvider.GetRequiredService<DbContextOptions<QuanLyBanSachContext>>()))
        {
            try
            {
                ...
                var prod1 = new SanPham
                {
                    ...
                    GiaNhap = 60000,
                    SoLuongTon = 50,
                    AnhBia = "https://www.netabooks.vn/Data/Sites/1/Product/78700/thumbs/truyen-kieu-bia-cung.jpg",
                    LoaiSanPham = "Sách",
                ...
                var prod2 = new SanPham
                {
                    ...
                    GiaNhap = 70000,
                    SoLuongTon = 35,
                    AnhBia = "https://www.netabooks.vn/Data/Sites/1/Product/38406/thumbs/de-men-phieu-luu-ky-bia-cung.jpg",
                    LoaiSanPham = "Sách",
                    MaDanhMuc = cat1.MaDanhMuc,
                ...
                var prod3 = new SanPham
                {
                    ...
                    GiaNhap = 240000,
                    SoLuongTon = 25,
                    AnhBia = "https://covers.openlibrary.org/b/isbn/9781617294532-L.jpg",
                    LoaiSanPham = "Sách",
                ...
                var prod4 = new SanPham
                {
                    ...
                    GiaNhap = 300000,
                    SoLuongTon = 20,
                    AnhBia = "https://covers.openlibrary.org/b/isbn/9781098104030-L.jpg",
                    LoaiSanPham = "Sách",
                    MaDanhMuc = cat2.MaDanhMuc,
                    MaNhaXuatBan = pub1.MaNhaXuatBan,
                    TrangThai = true,
                ...
                var prod5 = new SanPham
                {
                    ...
                    GiaNhap = 150000,
                    SoLuongTon = 45,
                    AnhBia = "https://covers.openlibrary.org/b/isbn/9781982137274-L.jpg",
                    LoaiSanPham = "Sách",
                ...
                var prod6 = new SanPham
                {
                    ...
                    GiaNhap = 140000,
                    SoLuongTon = 60,
                    AnhBia = "https://covers.openlibrary.org/b/isbn/9780735211292-L.jpg",
                    LoaiSanPham = "Sách",
                ...
                var prod7 = new SanPham
                {
                    ...
                    GiaNhap = 130000,
                    SoLuongTon = 30,
                    AnhBia = "https://covers.openlibrary.org/b/isbn/9780451524935-L.jpg",
                    LoaiSanPham = "Sách",
                    MaDanhMuc = cat1.MaDanhMuc,
                    MaNhaXuatBan = pub2.MaNhaXuatBan,
                    TrangThai = true,
                ...
                var prod8 = new SanPham
                {
                    ...
                    GiaNhap = 210000,
                    SoLuongTon = 40,
                    AnhBia = "https://minhkhai.com.vn/hinhlon/8935075937673.jpg",
                    LoaiSanPham = "Sách",
                ...
                {
                    new { Ten = "Norwegian Wood", MoTa = "Tiểu thuyết tình yêu nổi tiếng của Haruki Murakami", GiaBia = 210000m, GiaBan = 178000m, GiaNhap = 145000m, Ton = 38, Anh = "https://covers.openlibrary.org/b/isbn/9780375704024-L.jpg", DanhMuc = cat1, Nxb = pub3, TacGia = author4, Ngay = -18 },
                    new { Ten = "Harry Potter và Hòn Đá Phù Thủy", MoTa = "Tác phẩm fantasy được yêu thích trên toàn thế giới", GiaBia = 250000m, GiaBan = 219000m, GiaNhap = 170000m, Ton = 44, Anh = "https://covers.openlibrary.org/b/isbn/9780747532743-L.jpg", DanhMuc = cat1, Nxb = pub2, TacGia = author6, Ngay = -10 },
                    new { Ten = "Clean Code C#", MoTa = "Kỹ thuật viết mã sạch, dễ bảo trì trong C#", GiaBia = 360000m, GiaBan = 306000m, GiaNhap = 250000m, Ton = 22, Anh = "https://covers.openlibrary.org/b/isbn/9780132350884-L.jpg", DanhMuc = cat2, Nxb = pub1, TacGia = author3, Ngay = -8 },
                    new { Ten = "ASP.NET Core MVC thực chiến", MoTa = "Xây dựng website bán hàng bằng ASP.NET Core MVC và SQL Server", GiaBia = 390000m, GiaBan = 331500m, GiaNhap = 280000m, Ton = 28, Anh = "https://covers.openlibrary.org/b/isbn/9781617298301-L.jpg", DanhMuc = cat2, Nxb = pub1, TacGia = author3, Ngay = -5 },
                    new { Ten = "Trí tuệ nhân tạo nhập môn", MoTa = "Nền tảng về AI, machine learning và ứng dụng thực tế", GiaBia = 295000m, GiaBan = 250000m, GiaNhap = 210000m, Ton = 31, Anh = "https://covers.openlibrary.org/b/isbn/9780134610993-L.jpg", DanhMuc = cat2, Nxb = pub1, TacGia = author3, Ngay = -14 },
                    new { Ten = "Tư duy nhanh và chậm", MoTa = "Sách tâm lý học về cách con người ra quyết định", GiaBia = 230000m, GiaBan = 195000m, GiaNhap = 160000m, Ton = 37, Anh = "https://covers.openlibrary.org/b/isbn/9780374533557-L.jpg", DanhMuc = cat4, Nxb = pub4, TacGia = author7, Ngay = -21 },
                    new { Ten = "Đắc nhân tâm", MoTa = "Nghệ thuật giao tiếp và xây dựng quan hệ bền vững", GiaBia = 160000m, GiaBan = 136000m, GiaNhap = 105000m, Ton = 55, Anh = "https://covers.openlibrary.org/b/isbn/9780671027032-L.jpg", DanhMuc = cat4, Nxb = pub4, TacGia = author7, Ngay = -7 },
                    new { Ten = "Nhà giả kim", MoTa = "Câu chuyện truyền cảm hứng về hành trình đi tìm ước mơ", GiaBia = 145000m, GiaBan = 123000m, GiaNhap = 98000m, Ton = 48, Anh = "https://covers.openlibrary.org/b/isbn/9780062315007-L.jpg", DanhMuc = cat1, Nxb = pub3, TacGia = author4, Ngay = -16 },
                    new { Ten = "Khởi nghiệp tinh gọn", MoTa = "Phương pháp xây dựng sản phẩm và kiểm chứng mô hình kinh doanh", GiaBia = 260000m, GiaBan = 221000m, GiaNhap = 180000m, Ton = 30, Anh = "https://covers.openlibrary.org/b/isbn/9780307887894-L.jpg", DanhMuc = cat3, Nxb = pub4, TacGia = author7, Ngay = -12 },
                    new { Ten = "Quản trị học căn bản", MoTa = "Kiến thức nền tảng về quản trị doanh nghiệp", GiaBia = 240000m, GiaBan = 204000m, GiaNhap = 170000m, Ton = 34, Anh = "https://covers.openlibrary.org/b/isbn/9780134237473-L.jpg", DanhMuc = cat3, Nxb = pub4, TacGia = author7, Ngay = -25 },
                    new { Ten = "Marketing 5.0", MoTa = "Marketing trong thời đại công nghệ và dữ liệu", GiaBia = 280000m, GiaBan = 238000m, GiaNhap = 195000m, Ton = 26, Anh = "https://covers.openlibrary.org/b/isbn/9781119668510-L.jpg", DanhMuc = cat3, Nxb = pub4, TacGia = author7, Ngay = -11 },
                    new { Ten = "Sapiens - Lược sử loài người", MoTa = "Hành trình phát triển của nhân loại qua các thời kỳ", GiaBia = 320000m, GiaBan = 272000m, GiaNhap = 230000m, Ton = 29, Anh = "https://covers.openlibrary.org/b/isbn/9780062316097-L.jpg", DanhMuc = cat5, Nxb = pub1, TacGia = author5, Ngay = -13 },
                    new { Ten = "Địa lý Việt Nam hiện đại", MoTa = "Tổng quan lãnh thổ, vùng miền và đặc điểm tự nhiên Việt Nam", GiaBia = 210000m, GiaBan = 178500m, GiaNhap = 145000m, Ton = 33, Anh = "https://books.google.com/books/content?id=sCDt0AEACAAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api", DanhMuc = cat5, Nxb = pub4, TacGia = author1, Ngay = -17 },
                    new { Ten = "Lịch sử thế giới giản lược", MoTa = "Các nền văn minh và sự kiện nổi bật của thế giới", GiaBia = 300000m, GiaBan = 255000m, GiaNhap = 210000m, Ton = 27, Anh = "https://books.google.com/books/content?id=RqoV0AEACAAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api", DanhMuc = cat5, Nxb = pub4, TacGia = author5, Ngay = -20 },
                    ...
                    new { Ten = "Rừng Na Uy", MoTa = "Bản dịch tiếng Việt của Norwegian Wood", GiaBia = 220000m, GiaBan = 187000m, GiaNhap = 150000m, Ton = 24, Anh = "https://covers.openlibrary.org/b/isbn/9780375704024-L.jpg", DanhMuc = cat1, Nxb = pub3, TacGia = author4, Ngay = -6 },
                    new { Ten = "The Pragmatic Programmer", MoTa = "Tư duy thực dụng giúp lập trình viên viết phần mềm tốt hơn.", GiaBia = 320000m, GiaBan = 272000m, GiaNhap = 230000m, Ton = 32, Anh = "https://covers.openlibrary.org/b/isbn/9780135957059-L.jpg", DanhMuc = cat2, Nxb = pub1, TacGia = author3, Ngay = -18 },
                    ...
                    new { Ten = "Python Crash Course", MoTa = "Sách nhập môn Python dễ học, nhiều ví dụ thực hành.", GiaBia = 360000m, GiaBan = 306000m, GiaNhap = 250000m, Ton = 36, Anh = "https://covers.openlibrary.org/b/isbn/9781718502703-L.jpg", DanhMuc = cat2, Nxb = pub1, TacGia = author3, Ngay = -20 },
                    ...
                    new { Ten = "Blue Ocean Strategy", MoTa = "Chiến lược đại dương xanh trong kinh doanh.", GiaBia = 295000m, GiaBan = 250000m, GiaNhap = 205000m, Ton = 26, Anh = "https://covers.openlibrary.org/b/isbn/9781625274496-L.jpg", DanhMuc = cat3, Nxb = pub4, TacGia = author7, Ngay = -26 },
